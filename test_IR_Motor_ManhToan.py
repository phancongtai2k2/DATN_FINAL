...
def motor_control_with_ir(i):
    ...
    motorPin2 = 22  # Chan GPIO 26, chan vat ly 37
    enablePin = 14  # Chan GPIO 14, chan vat ly 8 (UART TXD)
    irSensorPin1 = 5  # Chan GPIO 4, chan vat ly 7
    irSensorPin2 = 6 # Chan GPIO 16, chan vat ly 36
    irSensorPin3 = 16 # Chan GPIO 17, chan vat ly 11
    irSensorPin4 = 26 # Chan GPIO 21, chan vat ly 40
...
motor_control_with_ir(4)  # Thay gia tri 1 bang gia tri ban muon kiem tra
